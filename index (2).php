...
<!--REGISTRO-->
  ...
  <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="#!" class="btn btn-waves modal-action modal-close waves-effect red darken-4">Cancelar</a>
        <input class="btn btn-waves modal-action  btn-flat light-green accent-4 white-text" type="submit" value="registrar">
            </div>
          </div>
      </div>
</div>
...
<?php
      ...
      $estado     = true; 
        ...
        $consultar = "select * from usuarios where cedula = '$cedula'";
        ...
        if($m > 0){
          ...
          if ($estado == true) {
            ...
            $sql = "insert into usuarios (cedula, nombre,correo,telefono,contrasenia,direccion) values ('".$cedula."','".$nombre."','".$correo."','".$telefono."','".$pass."','".$direc."')";
